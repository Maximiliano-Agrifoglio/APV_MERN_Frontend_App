  ...
  useEffect(() => {
    ...
    return (
       <>
          ...
          <h2 className="font-black text-3xl text-center mt-10 mr-32">Editar Perfil</h2>
          <p className="text-xl mt-5 mb-10 text-center mr-32">Completa tu perfil y Modifica tu {''} 
              <span className="text-indigo-600 font-bold">informacíon aquí</span>
          </p>
